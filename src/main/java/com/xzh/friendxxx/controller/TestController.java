...
public class TestController {
    ...
    @GetMapping("/pdf-urls")
    @Operation(summary = "获取PDF访问链接", description = "返回PDF生成服务的正确访问链接")
    public Result<Object> getPdfUrls(HttpServletRequest request) {
        ...
        return Result.success(java.util.Map.of(
            ...
            "downloadUrl", baseUrl + contextPath + "/pdf/private-overseas-travel-requirements",
            "previewUrl", baseUrl + contextPath + "/pdf/private-overseas-travel-requirements/preview",
            "swaggerUrl", baseUrl + contextPath + "/doc.html"
        ));
    }
}
